const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"assets/index-CauE49gZ.js",
			"assets/message-BVLkF6Qz.js",
			"assets/utils-BPyf_07k.js",
			"assets/game-COZ88_tM.js",
			"assets/index-Cpc8emp6.js",
			"assets/index-Vpwm-WxQ.js",
...
var Qh;
function A0() {
	return Qh || ((Qh = 1), (zc.exports = T0())), zc.exports;
}
var M = A0(),
	Mc = { exports: {} },
	fe = {};
...
var $h;
function Pc() {
	return $h || (($h = 1), (Mc.exports = R0())), Mc.exports;
}
var C = Pc(),
	Dc = { exports: {} },
	vu = {},
...
` +
	...
	function Nf(e, t, a) {
		...
		try {
			...
			if (
				((jr = !1),
				(Dn !== null || jn !== null) &&
					(Mi(), Dn && ((t = Dn), (e = jn), (jn = Dn = null), Cf(t), e)))
			)
	...
	function po(e) {
		...
		function z(A, E, O, j, $) {
			...
			if (typeof j == "object" && j !== null) {
				...
				if (typeof j.then == "function") return z(A, E, O, si(j), $);
	...
	function wo(e, t, a, n) {
		(t.value = a), (t.getSnapshot = n), No(t) && zo(e);
	}
	function Co(e, t, a) {
		return a(function () {
			No(t) && zo(e);
	...
	var dn = {
		...
		useSyncExternalStore: function (e, t, a) {
			...
			if (Ee) {
				...
				if (((a = t()), ze === null)) throw Error(c(349));
				Se & 60 || Oo(n, t, a);
			}
			u.memoizedState = a;
	...
	(za.useCacheRefresh = td),
		(za.useMemoCache = fs),
		(za.useHostTransitionStatus = bs),
		(za.useFormState = Bo),
		(za.useActionState = Bo),
	...
	function yd(e, t, a, n, u) {
		if (e !== null) {
			...
			if (Nl(r, n) && e.ref === t.ref)
				if (((Ie = !1), (t.pendingProps = n = r), Ms(e, u)))
					e.flags & 131072 && (Ie = !0);
	...
	function _d(e, t, a, n, u) {
		if ((yn(t), t.stateNode === null)) {
			...
			(e !== null && e.dependencies !== null && Ei(e.dependencies))
				? (typeof y == "function" && (Ss(t, a, y, n), (z = t.memoizedState)),
					(D =
						Da ||
						ud(t, a, D, n, w, z, b) ||
						(e !== null && e.dependencies !== null && Ei(e.dependencies)))
						? (T ||
								...
								(typeof r.componentWillUpdate == "function" &&
									r.componentWillUpdate(n, z, b),
								typeof r.UNSAFE_componentWillUpdate == "function" &&
									r.UNSAFE_componentWillUpdate(n, z, b)),
	...
	function Ad(e, t, a) {
		if (e !== null)
			if (e.memoizedProps !== t.pendingProps) Ie = !0;
				...
				if (!Ms(e, a) && !(t.flags & 128)) return (Ie = !1), xy(e, t, a);
				Ie = !!(e.flags & 131072);
			}
		...
		switch ((Fr(t), t.tag)) {
			...
			case 27:
				...
				if (e !== null && t.stateNode != null) e.memoizedProps !== n && ma(t);
					...
					(e = Gt.current),
						Ml(t) ? co(t) : ((e = Ah(u, n, a)), (t.stateNode = e), ma(t));
				}
				return je(t), null;
			case 5:
				...
				if (Me !== 0 && ve !== null) {
					...
					switch (Me) {
						...
						case 6:
							Nt.current === null && (t = !0);
							var T = Me;
							if (((Me = 0), (St = null), tl(e, y, b, T), a && Pn)) {
								d = 0;
								break e;
							}
							break;
						default:
							(T = Me), (Me = 0), (St = null), tl(e, y, b, T);
					}
				}
				zy(), (d = Be);
				break;
			...
			case "option":
				...
				for (b in n)
					if (
						((w = n[b]),
						(z = a[b]),
						n.hasOwnProperty(b) && w !== z && (w != null || z != null))
					)
						switch (b) {
							case "selected":
								e.selected =
					...
					if (r !== null)
						switch (r.tag) {
							case 3:
								...
								break;
							case 13:
								(y = Oa(r, 2)), y !== null && ot(y, r, 2), Mi(), Ac(r, 2);
						}
...
function M0() {
	...
	return i(), (Dc.exports = z0()), Dc.exports;
}
var D0 = M0();
const j0 = Tm(D0);
var yu = {},
...
var zm = C.createContext({ isTransitioning: !1 });
...
function cp() {
	...
	return (
		...
		C.useCallback(
			(h, m = {}) => {
				if ((Yt(p.current, Mm), !p.current)) return;
				if (typeof h == "number") {
					s.go(h);
					return;
				}
...
var Zm =
	...
	typeof window.document.createElement < "u";
try {
	Zm && (window.__reactRouterVersion = "7.1.5");
} catch {}
...
const ug = C.createContext({}),
	ig = ({ children: i }) => M.jsx(ug.Provider, { value: {}, children: i });
var xe;
(function (i) {
	i.assertEqual = (f) => f;
	function l(f) {}
		...
		children: M.jsxs("details", {
			children: [
				...
				M.jsxs("div", {
					...
					children: [
						M.jsx(S1, { darkMode: i.darkMode, setOptions: l }),
						M.jsxs(tr, {
							legend: "Show Names",
							children: [
								M.jsxs("label", {
...
function E1() {
	...
	return M.jsxs("div", {
		...
		children: [
			...
			M.jsx(x1, {}),
			M.jsx(pr, { children: M.jsx(lf, { to: "/", children: "Home" }) }),
			M.jsx(pr, {
				children: M.jsx("a", {
					target: "_blank",
...
const yb = C.lazy(() =>
		rf(() => import("./index-CauE49gZ.js"), __vite__mapDeps([0, 1, 2, 3, 4])),
	),
	pb = C.lazy(() => rf(() => import("./index-DU7FV--Y.js"), [])),
	gb = C.lazy(() =>
		rf(
			() => import("./index-Vpwm-WxQ.js"),
			...
			children: M.jsxs("div", {
				...
				children: [
					...
					M.jsx("div", {
						...
						children: M.jsxs(Tp, {
							children: [
								M.jsx(sl, { path: "/", element: M.jsx(yb, {}) }),
								M.jsx(sl, { path: "/dev/*", element: M.jsx(pb, {}) }),
								M.jsx(sl, { path: "/game/:id", element: M.jsx(gb, {}) }),
								M.jsx(sl, { path: "/name-generator", element: M.jsx(hb, {}) }),
								M.jsx(sl, { path: "/probability", element: M.jsx(vb, {}) }),
							],
						}),
					}),
				],
...
_b.render(
	M.jsx(C.StrictMode, {
		children: M.jsx(Jp, {
			children: M.jsx(ig, { children: M.jsx(p1, { children: M.jsx(bb, {}) }) }),
		}),
	}),
);
export {
