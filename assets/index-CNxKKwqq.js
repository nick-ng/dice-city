const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"assets/index-BbFInMmO.js",
			"assets/message-CNPFK-to.js",
			"assets/utils-BPyf_07k.js",
			"assets/game-B2b4Hgu1.js",
			"assets/index-DtrZpEOK.js",
			"assets/index-D83ETaiB.js",
...
function fc(e, t, n) {
	...
	if (t != null)
		...
		t))
			cc.call(t, r) && !dc.hasOwnProperty(r) && (i[r] = t[r]);
...
V.StrictMode = Kf;
V.Suspense = bf;
V.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = op;
V.act = pc;
...
var k = lc.exports;
const sp = rc(k),
	ap = Wf({ __proto__: null, default: sp }, [k]);
/**
 * @license React
 ...
 */ var up = k,
	...
	pp = up.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function hc(e, t, n) {
	...
	for (r in t) fp.call(t, r) && !hp.hasOwnProperty(r) && (i[r] = t[r]);
	if (e && e.defaultProps)
...
function Zn(e, t) {
	for (Nr[e] = t, e = 0; e < t.length; e++) gc.add(t[e]);
}
var vt = !(
		typeof window > "u" ||
...
var _t = vp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Pp(e, t, n, r, i, l, o, s, a) {
	(gr = !1), (Qi = null), Np.apply(Tp, arguments);
}
function jp(e, t, n, r, i, l, o, s, a) {
...
var $c = Me.unstable_scheduleCallback,
	Ba = Me.unstable_cancelCallback,
	Op = Me.unstable_shouldYield,
	Lp = Me.unstable_requestPaint,
	re = Me.unstable_now,
	Ip = Me.unstable_getCurrentPriorityLevel,
	As = Me.unstable_ImmediatePriority,
	Uc = Me.unstable_UserBlockingPriority,
	Ki = Me.unstable_NormalPriority,
	zp = Me.unstable_LowPriority,
	Fc = Me.unstable_IdlePriority,
	Nl = null,
	it = null;
function Mp(e) {
...
var Xe = Math.clz32 ? Math.clz32 : $p,
	Dp = Math.log,
	Ap = Math.LN2;
function $p(e) {
	return (e >>>= 0), e === 0 ? 32 : (31 - ((Dp(e) / Ap) | 0)) | 0;
}
var xi = 64,
	wi = 4194304;
function pr(e) {
...
function or(e, t) {
	e.blockedOn === t &&
		...
		Bo ||
			((Bo = !0),
			Me.unstable_scheduleCallback(Me.unstable_NormalPriority, Wp)));
}
function Or(e) {
	function t(i) {
		return or(i, e);
	...
	for (; 0 < Ct.length && ((n = Ct[0]), n.blockedOn === null); )
		Gc(n), n.blockedOn === null && Ct.shift();
}
...
function Fs(e, t, n, r) {
	if (Xi) {
		...
		else if ((Za(e, r), t & 4 && -1 < Bp.indexOf(e))) {
			for (; i !== null; ) {
				var l = ai(i);
				if (
					(l !== null && Zc(l),
...
var er = {
	...
	Qa = Ae(Tl),
	Kp = ee({}, Tl, { dataTransfer: 0 }),
	Yp = Ae(Kp),
	Xp = ee({}, si, { relatedTarget: 0 }),
	eo = Ae(Xp),
	Jp = ee({}, er, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
	qp = Ae(Jp),
	bp = ee({}, er, {
...
var oh = ee({}, si, {
	...
	ch = Ae(uh),
	dh = ee({}, er, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
	fh = Ae(dh),
	ph = ee({}, Tl, {
		deltaX: function (e) {
...
var vh = vt && "TextEvent" in window && !xr,
	Xc = vt && (!Ws || (xr && 8 < xr && 11 >= xr)),
	Ya = " ",
	Xa = !1;
function Jc(e, t) {
	switch (e) {
...
function gh(e, t) {
	if (Cn)
		return e === "compositionend" || (!Ws && Jc(e, t))
			? ((e = Yc()), (Mi = Vs = Pt = null), (Cn = !1), e)
			: null;
	switch (e) {
		case "paste":
			return null;
...
if (vt) {
	...
	ed = to && (!document.documentMode || 9 < document.documentMode);
}
function ba() {
	wr && (wr.detachEvent("onpropertychange", td), (Lr = wr = null));
}
function td(e) {
	if (e.propertyName === "value" && Pl(Lr)) {
		var t = [];
		bc(t, Lr, e, Ds(e)), zc(wh, t);
	}
}
function kh(e, t, n) {
	e === "focusin"
		? (ba(), (wr = t), (Lr = n), wr.attachEvent("onpropertychange", td))
		: e === "focusout" && ba();
}
function Sh(e) {
...
var Ph = vt && "documentMode" in document && 11 >= document.documentMode,
	Nn = null,
	Wo = null,
	_r = null,
	Ho = !1;
...
function jl(e) {
	...
	var t = Tn[e],
		n;
	for (n in t) if (t.hasOwnProperty(n) && n in id) return (ro[e] = t[n]);
	return e;
}
var ld = jl("animationend"),
	od = jl("animationiteration"),
	sd = jl("animationstart"),
	ad = jl("transitionend"),
	ud = new Map(),
	ru =
...
for (var io = 0; io < ru.length; io++) {
	var lo = ru[io],
		jh = lo.toLowerCase(),
		Rh = lo[0].toUpperCase() + lo.slice(1);
	Qt(jh, "on" + Rh);
}
Qt(ld, "onAnimationEnd");
Qt(od, "onAnimationIteration");
Qt(sd, "onAnimationStart");
Qt("dblclick", "onDoubleClick");
Qt("focusin", "onFocus");
Qt("focusout", "onBlur");
Qt(ad, "onTransitionEnd");
...
var hr =
	...
	Oh = new Set("cancel close invalid load scroll toggle".split(" ").concat(hr));
function iu(e, t, n) {
	...
	if (!e[Ei]) {
		(e[Ei] = !0),
			gc.forEach(function (n) {
				n !== "selectionchange" && (Oh.has(n) || oo(n, !1, e), oo(n, !0, e));
			});
		...
		if (!(t & 7)) {
			...
			T &&
				...
				0 < P.length &&
					...
					N ? (T.data = N) : ((N = qc(n)), N !== null && (T.data = N)))),
				(N = vh ? yh(e, n) : gh(e, n)) &&
...
var Yo = typeof setTimeout == "function" ? setTimeout : void 0,
	...
	Mh =
		typeof queueMicrotask == "function"
			...
			: typeof su < "u"
				? function (e) {
						return su.resolve(null).then(e).catch(Dh);
					}
				: Yo;
function Dh(e) {
	setTimeout(function () {
...
function fd(e, t, n) {
	...
	if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
		return n;
	r = r.getChildContext();
	for (var i in r) if (!(i in t)) throw Error(S(108, kp(e) || "Unknown", i));
	return ee({}, n, r);
}
function tl(e) {
	return (
...
function Kt() {
	if (!uo && ft !== null) {
		...
		try {
			...
			throw (ft !== null && (ft = ft.slice(e + 1)), $c(As, Kt), i);
		} finally {
			(H = t), (uo = !1);
		}
	}
...
var Fh = _t.ReactCurrentBatchConfig;
function ar(e, t, n) {
	if (
...
function ia(e, t, n, r, i, l) {
	if (
		...
		(t.updateQueue = null),
		(t.lanes = 0),
		($i.current = e === null || e.memoizedState === null ? Hh : Qh),
		(e = n(r, i)),
		kr)
	) {
		l = 0;
...
function Sd(e, t) {
	...
	if (
		...
		(r = r.queue),
		oa(Nd.bind(null, n, r, e), [e]),
		r.getSnapshot !== t || l || (ue !== null && ue.memoizedState.tag & 1))
	) {
		if (
			((n.flags |= 2048),
			Vr(9, Cd.bind(null, n, r, i, t), void 0, null),
			ce === null)
		)
			throw Error(S(349));
		un & 30 || Ed(n, t, i);
...
function Id(e, t, n) {
	return (
		(n = n != null ? n.concat([e]) : null), Ll(4, 4, Ld.bind(null, t, e), n)
	);
}
function sa() {}
function zd(e, t) {
...
function Dd(e, t, n) {
	return un & 21
		? (be(n, t) || ((n = Vc()), (b.lanes |= n), (cn |= n), (e.baseState = !0)),
			t)
...
function Wh(e, t, n) {
	...
	if ($d(e)) Ud(t, i);
		...
		(n = xd(e, t, i, r)),
			n !== null && ((i = ke()), Je(n, e, r, i), Fd(n, t, r));
	}
}
function $d(e) {
	var t = e.alternate;
...
var ul = {
	...
	Hh = {
		...
		useImperativeHandle: function (e, t, n) {
			return (
				...
				Ui(4194308, 4, Ld.bind(null, t, e), n)
			);
		},
		...
		useTransition: function () {
			var e = vu(!1),
				t = e[0];
			return (e = Bh.bind(null, e[1])), (nt().memoizedState = e), [t, e];
		},
		...
		useSyncExternalStore: function (e, t, n) {
			...
			return (
				(i.queue = l),
				yu(Nd.bind(null, r, l, e), [e]),
				(r.flags |= 2048),
				Vr(9, Cd.bind(null, r, l, n, t), void 0, null),
				n
			);
		},
		useId: function () {
	...
	Qh = {
		...
		useDeferredValue: function (e) {
			var t = Ze();
			return Dd(t, oe.memoizedState, e);
		},
		useTransition: function () {
			var e = po(Fr)[0],
				t = Ze().memoizedState;
	...
	Gh = {
		...
		useDeferredValue: function (e) {
			var t = Ze();
			return oe === null ? (t.memoizedState = e) : Dd(t, oe.memoizedState, e);
		},
		useTransition: function () {
			var e = ho(Fr)[0],
				t = Ze().memoizedState;
...
function wu(e, t, n) {
	...
	i.has(n) || (i.add(n), (e = am.bind(null, e, t, n)), t.then(e, e));
}
function _u(e) {
	do {
		var t;
...
function Eu(e, t, n, r, i) {
	if (e === null) {
		...
		return typeof l == "function" &&
			...
			? ((t.tag = 15), (t.type = l), Wd(e, t, l, r, i))
...
function Cu(e, t, n, r, i) {
	...
	if ((Fn(t, i), t.stateNode === null))
		Fi(e, t), Vd(t, n, r), ns(t, n, r, i), (r = !0);
	else if (e === null) {
		var o = t.stateNode,
			s = t.memoizedProps;
		o.props = s;
...
function bd(e) {
	...
	t !== null && ((e.alternate = null), bd(t)),
		...
		e.tag === 5 &&
			((t = e.stateNode),
			t !== null &&
				(delete t[rt], delete t[Dr], delete t[Xo], delete t[Ah], delete t[$h])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
		...
		case 5:
			...
			if (r & 4 && ((i = e.stateNode), i != null)) {
				...
				if (((e.updateQueue = null), a !== null))
					try {
						s === "input" && l.type === "radio" && l.name != null && Ec(i, l),
							Do(s, o);
						var u = Do(s, l);
						...
						(o = O),
							...
							o.tag === 22 && o.memoizedState !== null
								...
								: a !== null
									? ((a.return = o), (O = a))
									: Iu(i);
				for (; l !== null; ) (O = l), rf(l), (l = l.sibling);
				(O = i), (ji = s), (ye = u);
			}
			Ou(e);
		} else
...
function Re(e, t) {
	...
	if (r === 0)
		...
		if ((n != null && Ba(n), t === 1))
			e.tag === 0 ? Uh(zu.bind(null, e)) : pd(zu.bind(null, e)),
				Mh(function () {
					!(W & 6) && Kt();
				}),
				(n = null);
...
function lf(e, t) {
	...
	return Re(e, re()), e.callbackNode === n ? lf.bind(null, e) : null;
}
function ms(e, t) {
	var n = Er;
	return (
...
function rn(e, t) {
	...
	if ((n !== -1 && ((e.timeoutHandle = -1), zh(n)), ie !== null))
...
function om() {
	for (; ie !== null && !Op(); ) af(ie);
}
function af(e) {
	var t = df(e.alternate, e, Oe);
...
function bt(e, t, n) {
	var r = H,
		i = Ve.transition;
	try {
		(Ve.transition = null), (H = 1), sm(e, t, n, r);
	} finally {
		(Ve.transition = i), (H = r);
	}
	return null;
...
df = function (e, t, n) {
	if (e !== null)
		if (e.memoizedProps !== t.pendingProps || Pe.current) Te = !0;
			...
			if (!(e.lanes & n) && !(t.flags & 128)) return (Te = !1), Jh(e, t, n);
			Te = !!(e.flags & 131072);
		}
	else (Te = !1), X && t.flags & 1048576 && hd(t, rl, t.index);
	switch (((t.lanes = 0), t.tag)) {
		...
		case 3:
			e: {
				if ((Gd(t), e === null)) throw Error(S(387));
				(r = t.pendingProps),
					(l = t.memoizedState),
					(i = l.element),
					wd(e, t),
...
Lc = fa;
Ic = dn;
var ym = { usingClientEntryPoint: !1, Events: [ai, Pn, Rl, Rc, Oc, fa] },
	cr = {
...
De.hydrateRoot = function (e, t, n) {
	...
	if (
		...
		(t = hf(t, null, e, 1, n ?? null, i, !1, l, o)),
		(e[yt] = t.current),
		zr(e),
		r)
	)
...
function gf(e, t, n, r) {
	...
	let i = (l, o, s) => {
		...
		l.children &&
			...
			gf(l.children, t, d, u)),
			!(l.path == null && !l.index) &&
				t.push({ path: u, score: Lm(u, l.index), routesMeta: d });
	};
	return (
		e.forEach((l, o) => {
			var s;
			if (l.path === "" || !((s = l.path) != null && s.includes("?"))) i(l, o);
			else for (let a of xf(l.path)) i(l, o, a);
		}),
		t
	);
}
...
function Lm(e, t) {
	...
	return (
		...
		n
			.filter((i) => !Bu(i))
			.reduce((i, l) => i + (Nm.test(l) ? Tm : l === "" ? jm : Rm), r)
	);
}
function Im(e, t) {
	...
	for (let s = 0; s < r.length; ++s) {
		...
		Object.assign(i, c.params),
			o.push({
				...
				pathnameBase: Fm(Ut([l, c.pathnameBase])),
				route: f,
			}),
...
function Qm(e, t) {
	...
	let { basename: r, navigator: i } = k.useContext(yn),
		{ hash: l, pathname: o, search: s } = Nf(e, { relative: n }),
		a = o;
	return (
		r !== "/" && (a = o === "/" ? r : Ut([r, o])),
...
function Gm() {
	...
	let e = k.useContext(_a),
		...
		{ pathname: l } = di(),
		o = JSON.stringify(wf(i, n.v7_relativeSplatPath)),
		s = k.useRef(!1);
	return (
		Ef(() => {
			s.current = !0;
		...
		k.useCallback(
			function (u, d) {
				...
				let c = _f(u, JSON.parse(o), l, d.relative === "path");
				e == null &&
					t !== "/" &&
...
function Nf(e, t) {
	let { relative: n } = t === void 0 ? {} : t,
		...
		{ matches: i } = k.useContext(Yt),
		{ pathname: l } = di(),
		o = JSON.stringify(wf(i, r.v7_relativeSplatPath));
	return k.useMemo(() => _f(e, JSON.parse(o), l, n === "path"), [e, o, l, n]);
}
function Km(e, t) {
	return Ym(e, t);
}
...
const Jm = k.createElement(Xm, null);
...
function iv() {
	...
	let t = k.useContext(Sf),
		n = nv(vl.UseRouteError),
		r = Pf(vl.UseRouteError);
	return t !== void 0 ? t : (e = n.errors) == null ? void 0 : e[r];
}
function lv() {
	let { router: e } = tv(Tf.UseNavigateStable),
		t = Pf(vl.UseNavigateStable),
		n = k.useRef(!1);
	return (
		Ef(() => {
			n.current = !0;
...
function yv(e) {
	let { basename: t, children: n, future: r, window: i } = e,
		l = k.useRef();
	l.current == null && (l.current = wm({ window: i, v5Compat: !0 }));
	let o = l.current,
...
const gv =
	...
	wv = k.forwardRef(function (t, n) {
		let {
			...
			y,
			w = !1;
		if (typeof u == "string" && xv.test(u) && ((y = u), gv))
			try {
...
function Og(e) {
	let t = k.useRef(ws(e)),
		n = k.useRef(!1),
		r = di(),
		i = k.useMemo(() => pv(r.search, n.current ? null : t.current), [r.search]),
		l = Cf(),
		o = k.useCallback(
			(s, a) => {
...
const kv = k.createContext({}),
	Sv = ({ children: e }) => x.jsx(kv.Provider, { value: {}, children: e });
var Z;
(function (e) {
	e.assertEqual = (i) => i;
	function t(i) {}
...
class J extends U {
	...
	keyof() {
		return zf(Z.objectKeys(this.shape));
	}
}
J.create = (e, t) =>
	new J({
...
class Wt extends U {
	...
	_parse(t) {
		...
		if (
			(xl(this, mr) || Rf(this, mr, new Set(this._def.values)),
...
class ti extends U {
	...
	_parse(t) {
		...
		if (
			(xl(this, vr) ||
				Rf(this, vr, new Set(Z.getValidEnumValues(this._def.values))),
...
const Wv = (e, t = { message: `Input not instance of ${e.name}` }) =>
		Mf((n) => n instanceof e, t),
	Df = Ye.create,
	Af = Bt.create,
	Hv = Sl.create,
	Qv = Zt.create,
...
const _o = "DICE_CITY_OPTIONS",
	...
	Ff = k.createContext({ options: Uf, setOptions: () => {} }),
	Py = ({ children: e }) => {
		const t = localStorage.getItem(_o);
		let n = {};
		const r = Ty(t);
		r.success && (n = r.json);
		const [i, l] = k.useState({ ...Uf, ...n });
		return (
			k.useEffect(() => {
				(!i.playerId || !i.playerPassword) &&
					l((o) => {
						const s = { ...o };
						s.playerId || (s.playerId = Ju()),
							s.playerPassword || (s.playerPassword = Ju());
						const { ping: a, ...u } = s;
...
function Ly({ darkMode: e, setOptions: t }) {
	return x.jsxs(Wi, {
		legend: "Colour Theme",
		children: [
			x.jsxs("label", {
		...
		children: x.jsxs("details", {
			children: [
				...
				x.jsxs("div", {
					...
					children: [
						x.jsx(Ly, { darkMode: e.darkMode, setOptions: t }),
						x.jsxs(Wi, {
							legend: "Show Names",
							children: [
								x.jsxs("label", {
...
function zy() {
	...
	return x.jsxs("div", {
		...
		children: [
			...
			x.jsx(Iy, {}),
			x.jsx(El, { children: x.jsx(wv, { to: "/", children: "Home" }) }),
			x.jsx(El, {
				children: x.jsx("a", {
					target: "_blank",
...
const qy = rc(Jy),
	...
	eg = ["Robot", "Locomotive", "Automobile"],
	tg = ["Cactus", "Sunflower", "Poppy", "Banana"],
	ng = ["ChristopherNolan"],
	rg = ["MonopolySet"],
	bu = Object.freeze([...new Set([...by, ...eg, ...tg, ...ng, ...rg])]),
	ig = 1,
	ko = 2,
	lg = 4,
	ec = 5,
	...
	cg = ["Singular", "Multiple", "One", "Two", "Extra"],
	dg = ["Big", "Small", "Huge", "Little", "Colossal", "Tiny"],
	fg = [
		"Hardy",
		"Lonely",
		"Adamant",
	...
	pg = ["Brutal", "Kind", "Nippy", "Savage"],
	hg = ["Old", "Young", "Elder", "Adolescent"],
	mg = ["Quick", "Slow", "Fast", "Sluggish"],
	vg = [
		"Water",
		"Earthen",
		"Wooden",
	...
	yg = ["Solid", "Hard", "Squishy"],
	gg = ["Poisonous", "Venomous"],
	xg = Object.freeze(
		[
			...ug.map((e) => ({
				value: e,
	...
	_g = (e, t, n = !1) => (t && n ? t : Zf(e, wg)),
	Ig = (e, t, n, r) =>
		e.reduce(
			(i, { id: l, name: o }) => i.replaceAll(`%${l}%`, _g(l, o, t || l === n)),
			r,
		),
	tc = "NICK_NAME_GEN_STORE";
function kg() {
	...
	return (
		k.useEffect(() => {
			try {
				const d = localStorage.getItem(tc);
				if (typeof d == "string") {
...
const Cs = {
	...
	Sg = new Array(12).fill(0).map((e, t) => t + 1);
function So(e, t) {
	if (!e) return 0;
	let n = 0;
	return (
...
const Cg = k.lazy(() =>
		Sa(() => import("./index-BbFInMmO.js"), __vite__mapDeps([0, 1, 2, 3, 4])),
	),
	Ng = k.lazy(() => Sa(() => import("./index-DiLObUFv.js"), [])),
	Tg = k.lazy(() =>
		Sa(
			() => import("./index-D83ETaiB.js"),
			...
			children: x.jsxs("div", {
				...
				children: [
					...
					x.jsx("div", {
						...
						children: x.jsxs(uv, {
							children: [
								x.jsx(_n, { path: "/", element: x.jsx(Cg, {}) }),
								x.jsx(_n, { path: "/dev/*", element: x.jsx(Ng, {}) }),
								x.jsx(_n, { path: "/game/:id", element: x.jsx(Tg, {}) }),
								x.jsx(_n, { path: "/name-generator", element: x.jsx(kg, {}) }),
								x.jsx(_n, { path: "/probability", element: x.jsx(Eg, {}) }),
							],
						}),
					}),
				],
...
const jg = Eo.createRoot(document.getElementById("root"));
jg.render(
	x.jsx(k.StrictMode, {
		children: x.jsx(yv, {
			children: x.jsx(Sv, { children: x.jsx(Py, { children: x.jsx(Pg, {}) }) }),
		}),
	}),
);
export {
