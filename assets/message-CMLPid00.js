import { j as t, z as e } from "./index-DOlVKXak.js";
import { r as a } from "./utils-BPyf_07k.js";
import { s as r, a as n } from "./game-C_aYHwkw.js";
function k({ showStory: l, open: o }) {
	return t.jsx("div", {
...
const C = e.object({ gameId: e.string() }),
	x = e.object({ type: e.literal("not-found") }),
	f = e.object({
		type: e.literal("game-data"),
		payload: e.object({ playerGameData: n, latency: e.optional(e.number()) }),
	}),
	S = e.object({
		type: e.literal("ping"),
