...
- src-front/app/game-screen/game.tsx:79: @todo(nick-ng): reference for all establishments in sidebar
- src-front/app/game-screen/game.tsx:80: @todo(nick-ng): put side bar in its own component?
