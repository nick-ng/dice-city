const __vite__fileDeps = [
		"assets/index-B94vhc_s.js",
		"assets/message-DShfUG_z.js",
		"assets/utils-BPyf_07k.js",
		"assets/game-DizBCx6e.js",
		"assets/index-BXiYk3fz.js",
		"assets/index-B7QyQhEh.js",
...
function dc(e, t, n) {
	...
	if (t != null)
		...
		t))
			uc.call(t, r) && !cc.hasOwnProperty(r) && (i[r] = t[r]);
...
var k = ic.exports;
const op = nc(k),
	sp = Zf({ __proto__: null, default: op }, [k]);
/**
 * @license React
...
function pc(e, t, n) {
	...
	for (r in t) dp.call(t, r) && !pp.hasOwnProperty(r) && (i[r] = t[r]);
	if (e && e.defaultProps)
...
function Zn(e, t) {
	for (Nr[e] = t, e = 0; e < t.length; e++) yc.add(t[e]);
}
var vt = !(
		typeof window > "u" ||
...
var _t = mp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
...
function Tp(e, t, n, r, i, l, o, s, a) {
	(gr = !1), (Qi = null), Cp.apply(Np, arguments);
}
function Pp(e, t, n, r, i, l, o, s, a) {
	if ((Tp.apply(this, arguments), gr)) {
		if (gr) {
			var u = Qi;
			(gr = !1), (Qi = null);
...
function Mc(e) {
	return (e = jp(e)), e !== null ? Dc(e) : null;
}
function Dc(e) {
...
var Ac = Me.unstable_scheduleCallback,
	Ba = Me.unstable_cancelCallback,
	Rp = Me.unstable_shouldYield,
	Op = Me.unstable_requestPaint,
	re = Me.unstable_now,
	Lp = Me.unstable_getCurrentPriorityLevel,
	As = Me.unstable_ImmediatePriority,
	$c = Me.unstable_UserBlockingPriority,
...
var Xe = Math.clz32 ? Math.clz32 : Ap,
	Mp = Math.log,
	Dp = Math.LN2;
function Ap(e) {
	return (e >>>= 0), e === 0 ? 32 : (31 - ((Mp(e) / Dp) | 0)) | 0;
}
var xi = 64,
	wi = 4194304;
function pr(e) {
...
function Fs(e, t, n, r) {
	if (Xi) {
		...
		else if ((Za(e, r), t & 4 && -1 < Vp.indexOf(e))) {
			for (; i !== null; ) {
				var l = ai(i);
				if (
					(l !== null && Bc(l),
...
var er = {
	...
	Qa = Ae(Tl),
	Gp = ee({}, Tl, { dataTransfer: 0 }),
	Kp = Ae(Gp),
	Yp = ee({}, si, { relatedTarget: 0 }),
	eo = Ae(Yp),
	Xp = ee({}, er, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
	Jp = Ae(Xp),
	qp = ee({}, er, {
...
var lh = ee({}, si, {
	...
	uh = Ae(ah),
	ch = ee({}, er, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
	dh = Ae(ch),
	fh = ee({}, Tl, {
		deltaX: function (e) {
...
var mh = vt && "TextEvent" in window && !xr,
	Yc = vt && (!Ws || (xr && 8 < xr && 11 >= xr)),
	Ya = " ",
	Xa = !1;
function Xc(e, t) {
	switch (e) {
...
function yh(e, t) {
	if (Cn)
		return e === "compositionend" || (!Ws && Xc(e, t))
			? ((e = Kc()), (Mi = Vs = Pt = null), (Cn = !1), e)
			: null;
	switch (e) {
		case "paste":
			return null;
...
if (vt) {
	...
	bc = to && (!document.documentMode || 9 < document.documentMode);
}
function ba() {
	wr && (wr.detachEvent("onpropertychange", ed), (Lr = wr = null));
}
function ed(e) {
	if (e.propertyName === "value" && Pl(Lr)) {
		var t = [];
		qc(t, Lr, e, Ds(e)), Ic(xh, t);
	}
}
function _h(e, t, n) {
	e === "focusin"
		? (ba(), (wr = t), (Lr = n), wr.attachEvent("onpropertychange", ed))
		: e === "focusout" && ba();
}
function kh(e) {
...
var be = typeof Object.is == "function" ? Object.is : Ch;
function Ir(e, t) {
	if (be(e, t)) return !0;
...
function jl(e) {
	...
	var t = Tn[e],
		n;
	for (n in t) if (t.hasOwnProperty(n) && n in rd) return (ro[e] = t[n]);
	return e;
}
var id = jl("animationend"),
	ld = jl("animationiteration"),
	od = jl("animationstart"),
	sd = jl("transitionend"),
	ad = new Map(),
	ru =
...
for (var io = 0; io < ru.length; io++) {
	var lo = ru[io],
		Ph = lo.toLowerCase(),
		jh = lo[0].toUpperCase() + lo.slice(1);
	Qt(Ph, "on" + jh);
}
Qt(id, "onAnimationEnd");
Qt(ld, "onAnimationIteration");
Qt(od, "onAnimationStart");
Qt("dblclick", "onDoubleClick");
Qt("focusin", "onFocus");
Qt("focusout", "onBlur");
Qt(sd, "onTransitionEnd");
...
var hr =
	...
	Rh = new Set("cancel close invalid load scroll toggle".split(" ").concat(hr));
function iu(e, t, n) {
	...
	if (!e[Ei]) {
		(e[Ei] = !0),
			yc.forEach(function (n) {
				n !== "selectionchange" && (Rh.has(n) || oo(n, !1, e), oo(n, !0, e));
			});
...
var Yo = typeof setTimeout == "function" ? setTimeout : void 0,
	...
	zh =
		typeof queueMicrotask == "function"
			...
			: typeof su < "u"
				? function (e) {
						return su.resolve(null).then(e).catch(Mh);
					}
				: Yo;
function Mh(e) {
	setTimeout(function () {
...
var tr = Math.random().toString(36).slice(2),
	...
	Xo = "__reactEvents$" + tr,
	Dh = "__reactListeners$" + tr,
	Ah = "__reactHandles$" + tr;
function en(e) {
	var t = e[rt];
	if (t) return t;
...
function dd(e, t, n) {
	...
	if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
		return n;
	r = r.getChildContext();
	for (var i in r) if (!(i in t)) throw Error(S(108, _p(e) || "Unknown", i));
	return ee({}, n, r);
}
function tl(e) {
	return (
...
function Kt() {
	if (!uo && ft !== null) {
		...
		try {
			...
			throw (ft !== null && (ft = ft.slice(e + 1)), Ac(As, Kt), i);
		} finally {
			(H = t), (uo = !1);
		}
	}
...
var Uh = _t.ReactCurrentBatchConfig;
function ar(e, t, n) {
	if (
...
function ia(e, t, n, r, i, l) {
	if (
		...
		(t.updateQueue = null),
		(t.lanes = 0),
		($i.current = e === null || e.memoizedState === null ? Wh : Hh),
		(e = n(r, i)),
		kr)
	) {
		l = 0;
...
function kd(e, t) {
	...
	if (
		...
		(r = r.queue),
		oa(Cd.bind(null, n, r, e), [e]),
		r.getSnapshot !== t || l || (ue !== null && ue.memoizedState.tag & 1))
	) {
		if (
			((n.flags |= 2048),
			Vr(9, Ed.bind(null, n, r, i, t), void 0, null),
			ce === null)
		)
			throw Error(S(349));
		un & 30 || Sd(n, t, i);
...
function Ld(e, t, n) {
	return (
		(n = n != null ? n.concat([e]) : null), Ll(4, 4, Od.bind(null, t, e), n)
	);
}
function sa() {}
function Id(e, t) {
...
function Md(e, t, n) {
	return un & 21
		? (be(n, t) || ((n = Fc()), (b.lanes |= n), (cn |= n), (e.baseState = !0)),
			t)
...
function Zh(e, t, n) {
	...
	if (Ad(e)) $d(t, i);
		...
		(n = gd(e, t, i, r)),
			n !== null && ((i = ke()), Je(n, e, r, i), Ud(n, t, r));
	}
}
function Ad(e) {
	var t = e.alternate;
...
var ul = {
	...
	Wh = {
		...
		useImperativeHandle: function (e, t, n) {
			return (
				...
				Ui(4194308, 4, Od.bind(null, t, e), n)
			);
		},
		...
		useTransition: function () {
			var e = vu(!1),
				t = e[0];
			return (e = Vh.bind(null, e[1])), (nt().memoizedState = e), [t, e];
		},
		...
		useSyncExternalStore: function (e, t, n) {
			...
			return (
				(i.queue = l),
				yu(Cd.bind(null, r, l, e), [e]),
				(r.flags |= 2048),
				Vr(9, Ed.bind(null, r, l, n, t), void 0, null),
				n
			);
		},
		useId: function () {
	...
	Hh = {
		...
		useDeferredValue: function (e) {
			var t = Ze();
			return Md(t, oe.memoizedState, e);
		},
		useTransition: function () {
			var e = po(Fr)[0],
				t = Ze().memoizedState;
	...
	Qh = {
		...
		useDeferredValue: function (e) {
			var t = Ze();
			return oe === null ? (t.memoizedState = e) : Md(t, oe.memoizedState, e);
		},
		useTransition: function () {
			var e = ho(Fr)[0],
				t = Ze().memoizedState;
...
var Kh = _t.ReactCurrentOwner,
	Te = !1;
function _e(e, t, n, r) {
	t.child = e === null ? yd(t, null, n, r) : Qn(t, e.child, n, r);
}
...
function Eu(e, t, n, r, i) {
	if (e === null) {
		...
		return typeof l == "function" &&
			...
			? ((t.tag = 15), (t.type = l), Zd(e, t, l, r, i))
...
function Cu(e, t, n, r, i) {
	...
	if ((Fn(t, i), t.stateNode === null))
		Fi(e, t), Fd(t, n, r), ns(t, n, r, i), (r = !0);
	else if (e === null) {
		var o = t.stateNode,
			s = t.memoizedProps;
		o.props = s;
...
function qd(e) {
	...
	t !== null && ((e.alternate = null), qd(t)),
		...
		e.tag === 5 &&
			((t = e.stateNode),
			t !== null &&
				(delete t[rt], delete t[Dr], delete t[Xo], delete t[Dh], delete t[Ah])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
						...
						(o = O),
							...
							o.tag === 22 && o.memoizedState !== null
								...
								: a !== null
									? ((a.return = o), (O = a))
									: Iu(i);
				for (; l !== null; ) (O = l), nf(l), (l = l.sibling);
				(O = i), (ji = s), (ye = u);
			}
			Ou(e);
		} else
...
function Re(e, t) {
	...
	if (r === 0)
		...
		if ((n != null && Ba(n), t === 1))
			e.tag === 0 ? $h(zu.bind(null, e)) : fd(zu.bind(null, e)),
				zh(function () {
					!(W & 6) && Kt();
				}),
				(n = null);
...
function rf(e, t) {
	...
	return Re(e, re()), e.callbackNode === n ? rf.bind(null, e) : null;
}
function ms(e, t) {
	var n = Er;
	return (
...
function lm() {
	for (; ie !== null && !Rp(); ) sf(ie);
}
function sf(e) {
	var t = cf(e.alternate, e, Oe);
...
cf = function (e, t, n) {
	if (e !== null)
		if (e.memoizedProps !== t.pendingProps || Pe.current) Te = !0;
			...
			if (!(e.lanes & n) && !(t.flags & 128)) return (Te = !1), Xh(e, t, n);
			Te = !!(e.flags & 131072);
		}
	else (Te = !1), X && t.flags & 1048576 && pd(t, rl, t.index);
	switch (((t.lanes = 0), t.tag)) {
		...
		case 3:
			e: {
				if ((Qd(t), e === null)) throw Error(S(387));
				(r = t.pendingProps),
					(l = t.memoizedState),
					(i = l.element),
					xd(e, t),
...
function ff(e) {
	...
	if (e.tag === 1) {
		var n = e.type;
		if (je(n)) return dd(e, n, t);
	}
	return t;
}
function pf(e, t, n, r, i, l, o, s, a) {
	return (
...
Oc = fa;
Lc = dn;
var vm = { usingClientEntryPoint: !1, Events: [ai, Pn, Rl, jc, Rc, fa] },
	cr = {
	...
	ym = {
		...
		findFiberByHostInstance: cr.findFiberByHostInstance || hm,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
	...
	if (!Oi.isDisabled && Oi.supportsFiber)
		try {
			(Nl = Oi.inject(ym)), (it = Oi);
		} catch {}
}
De.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = vm;
...
De.hydrateRoot = function (e, t, n) {
	...
	if (
		...
		(t = pf(t, null, e, 1, n ?? null, i, !1, l, o)),
		(e[yt] = t.current),
		zr(e),
		r)
	)
...
function yf(e, t, n, r) {
	...
	let i = (l, o, s) => {
		...
		l.children &&
			...
			yf(l.children, t, d, u)),
			!(l.path == null && !l.index) &&
				t.push({ path: u, score: Om(u, l.index), routesMeta: d });
	};
	return (
		e.forEach((l, o) => {
			var s;
			if (l.path === "" || !((s = l.path) != null && s.includes("?"))) i(l, o);
			else for (let a of gf(l.path)) i(l, o, a);
		}),
		t
	);
}
...
function Om(e, t) {
	...
	return (
		...
		n
			.filter((i) => !Bu(i))
			.reduce((i, l) => i + (Cm.test(l) ? Nm : l === "" ? Pm : jm), r)
	);
}
function Lm(e, t) {
	...
	for (let s = 0; s < r.length; ++s) {
		...
		Object.assign(i, c.params),
			o.push({
				...
				pathnameBase: Um(Ut([l, c.pathnameBase])),
				route: f,
			}),
...
function Hm(e, t) {
	...
	let { basename: r, navigator: i } = k.useContext(yn),
		{ hash: l, pathname: o, search: s } = Cf(e, { relative: n }),
		a = o;
	return (
		r !== "/" && (a = o === "/" ? r : Ut([r, o])),
...
function Qm() {
	...
	let e = k.useContext(_a),
		...
		{ pathname: l } = di(),
		o = JSON.stringify(xf(i, n.v7_relativeSplatPath)),
		s = k.useRef(!1);
	return (
		Sf(() => {
			s.current = !0;
		...
		k.useCallback(
			function (u, d) {
				...
				let c = wf(u, JSON.parse(o), l, d.relative === "path");
				e == null &&
					t !== "/" &&
...
function Cf(e, t) {
	let { relative: n } = t === void 0 ? {} : t,
		...
		{ matches: i } = k.useContext(Yt),
		{ pathname: l } = di(),
		o = JSON.stringify(xf(i, r.v7_relativeSplatPath));
	return k.useMemo(() => wf(e, JSON.parse(o), l, n === "path"), [e, o, l, n]);
}
function Gm(e, t) {
	return Km(e, t);
}
...
const Xm = k.createElement(Ym, null);
...
function bm(e, t, n, r) {
	...
	return o.reduceRight((d, c, f) => {
		...
		n &&
			...
			(w = c.route.errorElement || Xm),
			a &&
				(u < 0 && f === 0
					? (lv("route-fallback", !1), (y = !0), (C = null))
					: u === f &&
...
function rv() {
	...
	let t = k.useContext(kf),
		n = tv(vl.UseRouteError),
		r = Tf(vl.UseRouteError);
	return t !== void 0 ? t : (e = n.errors) == null ? void 0 : e[r];
}
function iv() {
	let { router: e } = ev(Nf.UseNavigateStable),
		t = Tf(vl.UseNavigateStable),
		n = k.useRef(!1);
	return (
		Sf(() => {
			n.current = !0;
...
function mv(e) {
	let { basename: t, children: n, future: r, window: i } = e,
		l = k.useRef();
	l.current == null && (l.current = xm({ window: i, v5Compat: !0 }));
	let o = l.current,
...
const vv =
	...
	gv = k.forwardRef(function (t, n) {
		let {
			...
			y,
			w = !1;
		if (typeof u == "string" && yv.test(u) && ((y = u), vv))
			try {
...
function jg(e) {
	let t = k.useRef(ws(e)),
		n = k.useRef(!1),
		r = di(),
		i = k.useMemo(() => dv(r.search, n.current ? null : t.current), [r.search]),
		l = Ef(),
		o = k.useCallback(
			(s, a) => {
...
const wv = k.createContext({}),
	_v = ({ children: e }) => x.jsx(wv.Provider, { value: {}, children: e });
var Z;
(function (e) {
	e.assertEqual = (i) => i;
	function t(i) {}
...
const R = Z.arrayToEnum([
	...
	kv = (e) => JSON.stringify(e, null, 2).replace(/"([^"]+)":/g, "$1:");
...
const Cv = /^c[^\s-]{8,}$/i,
	...
	Lv = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let wo;
const Iv =
...
class J extends U {
	...
	keyof() {
		return If(Z.objectKeys(this.shape));
	}
}
J.create = (e, t) =>
	new J({
...
class Wt extends U {
	...
	_parse(t) {
		...
		if (
			(xl(this, mr, "f") || jf(this, mr, new Set(this._def.values), "f"),
			!xl(this, mr, "f").has(t.data))
		) {
			const n = this._getOrReturnCtx(t),
				r = this._def.values;
			return (
...
class ti extends U {
	...
	_parse(t) {
		...
		if (
			(xl(this, vr, "f") ||
				jf(this, vr, new Set(Z.getValidEnumValues(this._def.values)), "f"),
			!xl(this, vr, "f").has(t.data))
		) {
			const i = Z.objectValues(n);
			return (
...
const Bv = (e, t = { message: `Input not instance of ${e.name}` }) =>
		zf((n) => n instanceof e, t),
	Mf = Ye.create,
	Df = Bt.create,
	Zv = Sl.create,
	Wv = Zt.create,
...
const _o = "DICE_CITY_OPTIONS",
	...
	Uf = k.createContext({ options: $f, setOptions: () => {} }),
	Ny = ({ children: e }) => {
		const t = localStorage.getItem(_o);
		let n = {};
		const r = Cy(t);
		r.success && (n = r.json);
		const [i, l] = k.useState({ ...$f, ...n });
		return (
			k.useEffect(() => {
				(!i.playerId || !i.playerPassword) &&
					l((o) => {
						const s = { ...o };
						s.playerId || (s.playerId = Xu()),
							s.playerPassword || (s.playerPassword = Xu());
						const { ping: a, ...u } = s;
...
function Ry({ darkMode: e, setOptions: t }) {
	return x.jsxs(Wi, {
		legend: "Colour Theme",
		children: [
			x.jsxs("label", {
		...
		children: x.jsxs("details", {
			children: [
				...
				x.jsxs("div", {
					...
					children: [
						x.jsx(Ry, { darkMode: e.darkMode, setOptions: t }),
						x.jsxs(Wi, {
							legend: "Show Names",
							children: [
								x.jsxs("label", {
...
function Ly() {
	...
	return x.jsxs("div", {
		...
		children: [
			...
			x.jsx(Oy, {}),
			x.jsx(El, { children: x.jsx(gv, { to: "/", children: "Home" }) }),
			x.jsx(El, {
				children: x.jsx("a", {
					target: "_blank",
...
const Xy = nc(Yy),
	...
	qy = ["Robot", "Locomotive", "Automobile"],
	by = ["Cactus", "Sunflower", "Poppy", "Banana"],
	eg = ["ChristopherNolan"],
	tg = ["MonopolySet"],
	qu = Object.freeze([...new Set([...Jy, ...qy, ...by, ...eg, ...tg])]),
	ng = 1,
	ko = 2,
	rg = 4,
	bu = 5,
	...
	ag = ["Singular", "Multiple", "One", "Two", "Extra"],
	ug = ["Big", "Small", "Huge", "Little", "Colossal", "Tiny"],
	cg = [
		"Hardy",
		"Lonely",
		"Adamant",
	...
	dg = ["Brutal", "Kind", "Nippy", "Savage"],
	fg = ["Old", "Young", "Elder", "Adolescent"],
	pg = ["Quick", "Slow", "Fast", "Sluggish"],
	hg = [
		"Water",
		"Earthen",
		"Wooden",
	...
	mg = ["Solid", "Hard", "Squishy"],
	vg = ["Poisonous", "Venomous"],
	yg = Object.freeze(
		[
			...sg.map((e) => ({
				value: e,
	...
	xg = (e, t, n = !1) => (t && n ? t : Bf(e, gg)),
	Og = (e, t, n, r) =>
		e.reduce(
			(i, { id: l, name: o }) => i.replaceAll(`%${l}%`, xg(l, o, t || l === n)),
			r,
		),
	ec = "NICK_NAME_GEN_STORE";
function wg() {
	...
	return (
		k.useEffect(() => {
			try {
				const d = localStorage.getItem(ec);
				if (typeof d == "string") {
...
const Cs = {
	...
	_g = new Array(12).fill(0).map((e, t) => t + 1);
function So(e, t) {
	if (!e) return 0;
	let n = 0;
	return (
...
const Sg = k.lazy(() =>
		Sa(() => import("./index-B94vhc_s.js"), __vite__mapDeps([0, 1, 2, 3, 4])),
	),
	Eg = k.lazy(() => Sa(() => import("./index-CWSbuHPR.js"), [])),
	Cg = k.lazy(() =>
		Sa(
			() => import("./index-B7QyQhEh.js"),
			...
			children: x.jsxs("div", {
				...
				children: [
					...
					x.jsx("div", {
						...
						children: x.jsxs(sv, {
							children: [
								x.jsx(_n, { path: "/", element: x.jsx(Sg, {}) }),
								x.jsx(_n, { path: "/dev/*", element: x.jsx(Eg, {}) }),
								x.jsx(_n, { path: "/game/:id", element: x.jsx(Cg, {}) }),
								x.jsx(_n, { path: "/name-generator", element: x.jsx(wg, {}) }),
								x.jsx(_n, { path: "/probability", element: x.jsx(kg, {}) }),
							],
						}),
					}),
				],
...
const Tg = Eo.createRoot(document.getElementById("root"));
Tg.render(
	x.jsx(k.StrictMode, {
		children: x.jsx(mv, {
			children: x.jsx(_v, { children: x.jsx(Ny, { children: x.jsx(Ng, {}) }) }),
		}),
	}),
);
export {
