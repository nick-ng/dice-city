import { j as f, r as Y } from "./index-DOlVKXak.js";
import { a as Z } from "./game-C_aYHwkw.js";
import { e as I, l as K } from "./index-mSlpGTah.js";
import { v as E, t as P, g as L, b as ee } from "./build-DDdIQvre.js";
import {
	b as te,
	s as ae,
	j as re,
...
import { g as se, E as ie } from "./index-BlHTT1_o.js";
...
const oe = (e, t) => {
	...
	de = (e, t, l = !1) => {
		...
		const S = p.length;
		if (((a.diceRolls = D(S, 6)), (a.harbourExtra = 0), S === 1))
			a.turnEvents.push(
						...
						o !== 0 &&
							Object.values(l.players).forEach((b) => {
								...
								const { city: g } = b,
									...
									M = (($ = m[n]) == null ? void 0 : $.length) || 0;
								if (M < 1 || (S && !d.harbour)) return;
								const k = M * o;
								(b.money += k),
									k > 0 &&
										(y &&
											...
											(y = !1)),
										a.push(
											`id:${Date.now()}:%${b.playerId}% collected ${k} ${k === 1 ? "coin" : "coins"} from the bank - ${M} ${M === 1 ? i.display : i.pluralDisplay}`,
										),
										P(a));
							});
				}),
			...
			Object.entries(I)
				...
				.forEach(([b, g]) => {
					...
					switch (b) {
						...
						case "flowerShop": {
							const F = S ? 2 : 1,
								v = (($ = i.flowerGarden) == null ? void 0 : $.length) || 0;
							d = F * v;
							break;
						}
						case "foodWarehouse": {
					...
					(p.money += M),
						a.push(b),
						r.push(
							`id:${Date.now()}:%${c}% collected ${M} ${M === 1 ? "coin" : "coins"} from the bank - ${m} ${m === 1 ? g.display : g.pluralDisplay}`,
						);
				}),
			P(r),
			{ gameData: e }
				...
				.forEach(([S, b]) => {
					...
					o.forEach((F) => {
						...
						const v = s[F],
							...
							R = ((q = A[S]) == null ? void 0 : q.length) || 0;
						if (R === 0) return;
						let O = g;
						if ((x.shoppingMall && (O += m), d)) {
							if (!x.harbour) return;
							(O = M), x.shoppingMall && (O += k);
						}
						const j = O * R;
						if ($.money === 0) {
							y.push(
						...
						$.money < j
							? (y.push(
									`id:${Date.now()}:%${F}% collected ${$.money} ${$.money === 1 ? "coin" : "coins"} from %${r}% - ${R} ${R === 1 ? b.display : b.pluralDisplay}`,
								),
								(v.money += $.money),
								($.money = 0))
							: (y.push(
		...
		return (
			Object.entries(I)
				...
				.forEach(([m, d]) => {
					...
					const { establishments: M } = S,
						k = (($ = M[m]) == null ? void 0 : $.length) || 0;
					if (k === 0) {
						h.push(m);
						return;
					}
					switch (m) {
						...
						case "tvStation": {
							(g = "after-roll"), i.push({ playerId: r, action: "tv-station" });
							break;
						}
						case "businessCentre": {
							(g = "after-roll"),
	...
	ye = (e, t, l = !1) => {
		...
		if (l) return { gameData: e };
		const { city: g } = a[r],
			m = ((M = g.establishments.tvStation) == null ? void 0 : M.length) || 0,
			d = be * m;
		return d === 0
			? { gameData: e }
			: (b.money === 0
...
const G = [ve, Me, Oe, Ee, Ne, Ye, We, et, st, dt, pt, kt, Pt, Ot, xt]
		.flat()
		.map((e, t) => ({ ...e, id: t + 1 })),
	Bt = (e, t) => {
