...
const startingState: GameData["gameState"] = {
  publicState: {
    ...
    common: {
      ...
      turnEvents: ["%84c45332-4911-4823-839e-996bad56ba61% rolled a 2"],
      supply: {
        familyRestaurant: [
          "familyRestaurant:5",
          "familyRestaurant:4",
...
export const blueRanchTests: TestScenario[] = [
  {
    tags: ["blue-establishments", "ranch", "success"],
    display:
      "Blue-establishments: Player A rolls a 2 and has 3 ranches, Player B has 1 ranch",
    startingData,
    action: {
