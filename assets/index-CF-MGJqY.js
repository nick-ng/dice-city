...
const d = [
		{
			...
			Element: l.lazy(() =>
				s(
					() => import("./index-DmtEgcAe.js").then((t) => t.i),
					__vite__mapDeps([0, 1]),
				),
			),
		},
		{
			...
			Element: l.lazy(() =>
				s(
					() => import("./dev-all-buildings-uyI8OyMk.js"),
		...
		},
		{
			...
			Element: l.lazy(() =>
				s(
					() => import("./supply-total-afPhD0cL.js"),
