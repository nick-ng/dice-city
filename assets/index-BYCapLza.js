...
const d = [
		{
			...
			Element: l.lazy(() =>
				s(
					() => import("./index-CHqaZAj-.js").then((t) => t.i),
					__vite__mapDeps([0, 1]),
				),
			),
		},
		{
			...
			Element: l.lazy(() =>
				s(
					() => import("./dev-all-buildings-CMk7P-z9.js"),
		...
		},
		{
			...
			Element: l.lazy(() =>
				s(
					() => import("./supply-total-DSf1DlIf.js"),
